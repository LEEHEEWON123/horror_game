...
public class InsurgentPlayableLocomotion : MonoBehaviour
{
    ...
    public void Bind(NavMeshAgent agent, Animator animator, AnimationClip clip)
    {
        ...
        _graph = PlayableGraph.Create("InsurgentLocomotion");
        _graph.SetTimeUpdateMode(DirectorUpdateMode.GameTime);

        var output = AnimationPlayableOutput.Create(_graph, "InsurgentOutput", animator);
